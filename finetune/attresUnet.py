...
class SelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # (hwd,batch,-1) (batch,-1,hwd) = (hwd,hwd)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_path', type=str, default='/braindat/lab/chenyd/MODEL/Neurips23_imgSSL/BYOL0413/resnet50_60000.pth')
