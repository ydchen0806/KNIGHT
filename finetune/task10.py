...
def arg_parse():
    ...
    parse.add_argument('--task_name', type=str, default='Task10_Colon') # need to change
    parse.add_argument('--save_dir', type=str, default='/data/ydchen/VLP/MODEL/NeurIPS_MSD_0418')
    parse.add_argument('--json_name', type=str, default='task10') # need to change
