...
def arg_parse():
    ...
    parse.add_argument('--task_name', type=str, default='Task03_Liver') # need to change
    parse.add_argument('--save_dir', type=str, default='/data/ydchen/VLP/MODEL/NeurIPS_MSD_0418')
    parse.add_argument('--json_name', type=str, default='task3') # need to change
...
val_ds = CacheDataset(data=val_files, transform=val_transforms, cache_num=4, cache_rate=1.0, num_workers=4)
