...
def arg_parse():
    ...
    parse.add_argument('--task_name', type=str, default='Task05_Prostate') # need to change
    parse.add_argument('--save_dir', type=str, default='/data/ydchen/VLP/MODEL/NeurIPS_MSD_0421_barlowClip')
    parse.add_argument('--json_name', type=str, default='task5') # need to change
    parse.add_argument('--pretrained', type=bool, default=True)
    parse.add_argument('--pretrained_path', type=str, default='/data/ydchen/EM_pretraining_data/BarlowClip/testgenerate_then_optimize_pretrain_7000_iterations_encoder.pth')
