...
sys.path.append('/code/research-contributions-main/UNETR/BTCV')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-id', '--model_id', type=str, default='UNETR')
    ...
    if cfg.MODEL.model_type == 'mala':
        ...
        print(f'img size is {cfg.MODEL.unetr_size}')
        
    ckpt_path = os.path.join('/data/cyd0806/superhuman/models/UNETR_model_MSE_CREMIC_0106/2023-01-07--13-48-31_seg_3d/model-200000.pt')
